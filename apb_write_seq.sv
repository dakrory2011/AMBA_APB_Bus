package apb_wr_only_seq_pack;
  import uvm_pkg::*;
  `include "uvm_macros.svh"
  import apb_seq_item_pack::*;

  class apb_wr_only_seq extends uvm_sequence #(apb_seq_item);
    `uvm_object_utils(apb_wr_only_seq)
      apb_seq_item seq_item;
    function new(string name = "apb_wr_only_seq");
      super.new(name);
    endfunction
    ...
    task body;
      repeat (1000) begin
        ...
        seq_item.c_read_cmd.constraint_mode(0);
